...
\newcommand{\jcnote}[1]{%
    {\color{blue}\textbf{Jessica says:} #1}%
}

% Review markup: blue for additions, red strikethrough for deletions
...
\newcommand{\addr}{\mathtt{addr}} %Memory address
...
% Absorb small prose overfulls as a last-resort line-break stretch.
